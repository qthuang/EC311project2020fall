...
HD_PWD='C:/Users/ynn1999/FJTPDS/Lab3333.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Combine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Combine.tcl -notrace
